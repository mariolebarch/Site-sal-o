  ...
  return (
    <div className="space-y-8 max-w-md">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-blush-200 p-6 shadow-soft space-y-4">
        ...
        <div>
          <label className="block text-xs font-medium text-ink-500 mb-1">Senha atual</label>
          <input
            type="password"
            required
            value={current}
        ...
        <button
          type="submit"
          className="rounded-full bg-rose-600 hover:bg-rose-700 text-white text-sm font-semibold px-5 py-2.5 transition-colors"
        >
          Salvar nova senha
        </button>
      </form>
